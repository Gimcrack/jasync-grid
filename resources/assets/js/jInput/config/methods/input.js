...
;module.exports = function (self) {
    ...
    return {
        ...
        getAtts: function () {
            ...
            var filteredAtts = _.pickBy(self.options.atts, function (value, key) {
        ...
        setValue: function (value) {
            ...
            switch (self.type) {
                ...
                case 'select' :
                    ...
                    if (typeof value === 'object' && !!_.map(value, 'id').length) {
                ...
                case 'tokens' :
                    //self.DOM.$inpt.tokenfield('setTokens', _.map(value, 'name'));
        ...
        labelHandler: function () {
            if (self.type === 'hidden' || !self.options.atts._label) return;
