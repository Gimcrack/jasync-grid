    ...
    return {
        ...
        getExtOptions: function (force, callback) {
            ...
            window.axios
                .get(url, { params: data } )
                .then( (response) => {
                    self.fn.buildOptions(response.data);
        ...
        populateTokensOptions: function () {
            ...
            self.DOM.$inpt.data('tokenFieldSource', _.map(self.JSON, 'name'));
        }, //end fn
        ...
        populateSelectOptions: function () {
            ...
            if (self.options.extData) {
                oAtts()._labels = _.map(self.JSON, 'label');
                oAtts()._options = _.map(self.JSON, 'option');
