...
function nfx_thumbslide(image,message,type) {
	if(typeof type === 'undefined') type = 'primary';
	var notification = new NotificationFx({
		message : '<div class="ns-thumb"><img height="64" width="64" src="' + image + '"/></div><div class="ns-content"><p>' + message + '</div>',
		layout : 'other',
		ttl : 6000,
		effect : 'thumbslider',
...
function nfx_bouncyflip(image,message) {
	var notification = new NotificationFx({
		message : '<p><img align="left" style="margin-right:6px" height="64" width="64" src="' + image + '"/>' + message + '</p>',
		layout : 'attached',
		effect : 'bouncyflip',
...
function nfx_jelly(image,message) {
	var notification = new NotificationFx({
		message : '<p><img align="left" style="margin-right:6px" height="64" width="64" src="' + image + '"/>' + message + '</p>',
		layout : 'growl',
		effect : 'jelly',
		type : 'inverse', // notice, warning, error or success
	}).show();
}

function nfx_genie(image,message,type) {
	if(typeof type === 'undefined') type = 'primary';
	console.log('<p><img align="left" style="margin-right:6px" height="64" width="64" src="' + image + '"/>' + message + '</p>');
	var notification = new NotificationFx({
		message : '<p><img align="left" style="margin-right:6px" height="64" width="64" src="' + image + '"/>' + message + '</p>',
		layout : 'growl',
		effect : 'genie',
